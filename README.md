...
git clone https://github.com/regmicmahesh-dotfiles/nvim.git ~/.config/nvim
```

### Clone manually (Windows)
```sh
# Strongly recommended: Fork the repo and clone YOUR fork.
git clone https://github.com/regmicmahesh-dotfiles/nvim.git %USERPROFILE%\AppData\Local\nvim && nvim
```
